            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 order-lg-2 order-1">
                    <div class="headtte14m box-shadow_main">
                        ...
                        <h4>Certificates (<?= count($certificates); ?>)</h4>

                        <button class="act-btn btn-hover" type="button" style="width: 20%;margin-left: 100px;">
                            <a href="<?= base_url('request-certificate'); ?>">Request</a>
                        </button>
                    </div>
                                ...
                                <?php foreach ($certificates as $cert): ?>
                                    <div class="col-xl-4 col-lg-6 col-md-6">
                                        <div class="ppuser-card mb-4">
                                            ...
                                            <div class="ppuser-img text-center">
                                                <img class="ft-plus-square job-bg-circle bg-cyan me-0"
                                                    src="<?= base_url('public/layout/images/group-imgs/img-5.jpg'); ?>"
                                                    alt="">
                                            </div>

                                            <!-- Certificate Type -->
                                            <a href="#" class="job-heading text-center">
                                            ...
                                            <p class="notification-text font-small-4 text-center">
                                                <span class="oflst126">
                                                    Certificate No: CERT-<?= esc($cert['id']); ?>
                                                </span>
                                            </p>
                                            ...
                                            <!-- View Button Only If Approved or Rejected -->
                                            <?php if (in_array($status, ['approved', 'rejected']) && !empty($cert['certificate_file'])): ?>
                                                <div class="text-center">
                                                    <a href="<?= base_url('uploads/certificates/' . $cert['certificate_file']); ?>"
                                                        target="_blank"
