                                            ...
                                            <?php if (!empty($members)): ?>
                                                <?php foreach ($members as $index => $member): ?>
                                                    <div class="member row g-3 mb-3 border rounded p-3 align-items-end">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input type="date" name="members[<?= $index ?>][baptism_date]"
                                                                class="form-control"
                                                                value="<?= !empty($member['baptism_date']) ? esc($member['baptism_date']) : '' ?>">
                                                        </div>

                                                        <div class="col-md-2">
                                                            <input type="date" name="members[<?= $index ?>][feast]"
                                                                class="form-control"
...
<script>
    ...
    function addMember() {
        ...
        div.innerHTML = `
        <div class="col-md-2"><input type="text" name="members[${memberIndex}][full_name]" class="form-control" placeholder="Full Name"></div>
        <div class="col-md-2">
        ...
        <div class="col-md-2"><input type="date" name="members[${memberIndex}][date_of_birth]" class="form-control"></div>
        <div class="col-md-2">
    <input type="date" name="members[${memberIndex}][baptism_date]" class="form-control">
</div>
<div class="col-md-2">
    <input type="date" name="members[${memberIndex}][feast]" class="form-control">
</div>
        <div class="col-md-1"><input type="text" name="members[${memberIndex}][gender]" class="form-control" placeholder="Gender"></div>
        <div class="col-md-2"><textarea name="members[${memberIndex}][job]" class="form-control" rows="2" placeholder="Job Details"></textarea></div>
        <div class="col-md-2"><input type="text" name="members[${memberIndex}][education]" class="form-control" placeholder="Education"></div>
        <div class="col-md-2"><input type="text" name="members[${memberIndex}][phonenumber]" class="form-control" placeholder="Phone"></div>
        <div class="col-md-2"><input type="text" name="members[${memberIndex}][current_status]" class="form-control" placeholder="Status"></div>
        <div class="col-md-1 d-flex align-items-end"><button type="button" class="btn btn-danger btn-sm" onclick="removeMember(this)">✖</button></div>
    `;
