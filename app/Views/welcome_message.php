                ...
                <aside class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="event-card rrmt-30 lgmt-30">
                        <div class="headtte14m">
                            ...
                            <a href="my_profile_connections.html">Members</a>
                            <div class="count-dt"><?php echo $totalMembers?></div>
                        </div>
                        <div class="panel-photos">
                            <div class="row g-0"><?php if (!empty($families) && is_array($families)): ?>
                                    <?php foreach ($families as $family): ?>
                                        <div class="col-lg-4 col-md-3 col-3">
                                            <div class="circled-user-box">
                                                <a href="#">
                                                    <!-- Show family photo if available, else fallback image -->
                                                    <img src="<?= base_url('uploads/family/' . $family['photo']) ?>">
                                                    <div class="name-user"><?= esc($family['family_name']); ?></div>
                                                </a>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
