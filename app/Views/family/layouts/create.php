<div class="page-content">
        ...
        <div class="member border rounded p-3 mb-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <textarea name="members[0][job]" class="form-control" rows="2"></textarea>
                </div>
    ...
    <button type="button" class="btn btn-outline-secondary btn-sm mt-3" onclick="addMember()">
        + Add Another Member
    </button>
</div>
...
function addMember() {
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3">
            <label class="form-label">Job Details</label>
            <textarea name="members[${memberIndex}][job]" class="form-control" rows="2"></textarea>
        </div>
        ...
        <div class="col-md-3">
            <label class="form-label">Feast (MM-DD)</label>
            <input type="text"
                   name="members[${memberIndex}][feast]"
                   class="form-control feast-input"
                   placeholder="MM-DD"
                   maxlength="5">
        </div>
